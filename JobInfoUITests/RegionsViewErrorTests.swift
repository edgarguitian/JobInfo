...
final class RegionsViewErrorTests: XCTestCase {

    private var app: XCUIApplication!
    override func setUp() {
        continueAfterFailure = false
        app = XCUIApplication()
        app.launchArguments += [IdentifiersUI.errorHandlingJobsRegions]
        app.launch()
    }
    ...
    func test_regions_view_screen_show_error() throws {
        /// Nav Region
